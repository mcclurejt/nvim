return function()
  ...
  local FileNameModifer = {
    hl = function()
      if vim.bo.modified then
        ...
        return { fg = 'lavender', bold = true, force = true }
      end
    end,
  }
  ...
  FileType = utils.surround({ "", "" }, "surface0", { FileType })
  ...
  ScrollBar = utils.surround({ "", "" }, "surface0", { ScrollBar })
  ...
  Diagnostics = utils.surround({ "", "" }, "surface0", { Diagnostics })
  ...
  Git = utils.surround({ "", "" }, "surface0", { Git })
  ...
  local GitStatus = {
    ...
    },
    {
      condition = function(self)
        ...
        return added and (changed or removed)
      end,
      provider = " "
    },
    {
  ...
  GitStatus = utils.surround({ "", "" }, "surface0", { GitStatus })
  ...
  local DefaultStatusline = {
    ViMode, Space, Git, Space, GitStatus, Align,
    FileNameBlock, Align, Diagnostics, Space, FileType, Space, ScrollBar,
  }
